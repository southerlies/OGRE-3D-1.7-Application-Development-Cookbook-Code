...
void CDelaunayDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CDelaunayDoc::InitializeSearchContent()
{
...
void CDelaunayDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
