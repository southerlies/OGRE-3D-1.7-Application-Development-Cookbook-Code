...
void CImageEditorDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CImageEditorDoc::InitializeSearchContent()
{
...
void CImageEditorDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
