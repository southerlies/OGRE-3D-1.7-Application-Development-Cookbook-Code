...
void COrbitViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void COrbitViewDoc::InitializeSearchContent()
{
...
void COrbitViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
