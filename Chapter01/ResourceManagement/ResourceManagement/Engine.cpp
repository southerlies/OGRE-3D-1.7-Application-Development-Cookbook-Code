	...
	: m_Root(NULL)
{
	...
	CString ApplicationName = "ResourceManagement.exe";
	...
	m_Root = new Ogre::Root("", "", Ogre::String(ApplicationPath + "ResourceManagement.log")); 
...
#define new DEBUG_NEW
	...
	Ogre::ResourceGroupManager::getSingleton().createResourceGroup("StlFile", true);
	Ogre::ResourceGroupManager::getSingleton().initialiseResourceGroup("StlFile");
	Ogre::ResourceGroupManager::getSingleton().addResourceLocation(Ogre::String(ApplicationPath) + Ogre::String("..\\..\\media\\stl\\Tubes\\hoses\\curvature"),
		"FileSystem","StlFile");
